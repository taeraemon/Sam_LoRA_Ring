...
def parse_args():
    parser = argparse.ArgumentParser(description="LoRA-SAM inference with flexible box prompt")
    ...
    parser.add_argument('--lora_weights', type=str, required=True, help="LoRA weights path (.safetensors/.pt)")
...
def main():
    ...
    sam_lora = LoRA_sam(sam, lora_rank)
